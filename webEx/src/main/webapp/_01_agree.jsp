...
<body>
    <header>
        <div class="header">
            <h1><a href="www.naver.com"></a>NAVER</h1>
        </div>
    </header>
    <!-- -->
    
        <form action="_03_join.jsp" >
            <h4><input type="checkbox" name="terms" id="check1">네이버 이용약관 동의 <span>(필수)</span></h4>
            <textarea colspan="100" row="15"> 여러분을 환영합니다.
...
여러분은 PC, 휴대폰 등 인터넷 이용이 가능한 각종 단말기를 통해 각양각색의 네이버 서비스를 자유롭게 이용하실 수 있으며, 개별 서비스들의 구체적인 내용은 각 서비스 상의 안내, 공지사항, 네이버 웹고객센터(이하 ‘고객센터’) 도움말 등에서 쉽게 확인하실 수 있습니다.
            ...
            <h4><input type="checkbox" name="terms" id="check2">개인정보 수집 밎 이용동의 <span>(필수)</span></h4>
            <textarea colspan="100" row="15">개인정보보호법에 따라 네이버에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간, 동의 거부권 및 동의 거부 시 불이익에 관한 사항을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.
            ...
            <h4><input type="checkbox" name="terms" id="check3">위치정보 이용약관 동의 <span>(선택)</span></h4>
            <textarea colspan="100" row="15">위치정보 이용약관에 동의하시면, 위치를 활용한 광고 정보 수신 등을 포함하는 네이버 위치기반 서비스를 이용할 수 있습니다.
            ...
            <h4><input type="checkbox"  name="terms" id="check4">프로모션 정보 수신 동의 <span>(선택)</span></h4>
            ...
            <input type="button" value="확인" id="confirm" onclick="checkVal(form)">
        </form>
